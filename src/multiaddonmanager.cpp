...
constexpr const byte g_ g_ReplyConnection_Sig[] = "\x48\x8B\xC4\x55\x41\x54\x41\x55\x41\x57";
#else
...
constexpr const byte g_ReplyConnection_Sig[] = "\x55\x48\x8D\x05\xE8\xC2\xC1\xFF\x66\x0F\xEF\xC0\x48\x89\xE5\x41\x57";
#endif
